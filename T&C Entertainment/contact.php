...
// configure
$from = 'no-reply@tandcentertainment.com';
$sendTo = 'tandcentertainment@gmail.com';
$subject = 'New message from contact form';
$fields = array('name' => 'Name', 'email' => 'Email', 'message' => 'Message'); // array variable name => Text to appear in email
$okMessage = '<div id="contact-success" class="alert alert-success alert-dismissable" role="alert" style="position: absolute;top: 90px;left: 20%;right: 20%;"><button type="button" class="close" data-dismiss="alert" aria-label="Close" style="position:relative;z-index:2"><span aria-hidden="true">&times;</span></button>Contact form successfully submitted. Thank you, I will get back to you soon!</div>';
$errorMessage = '<div id="contact-fail" class="alert alert-warning alert-dismissable" role="alert" style="position: absolute;top: 90px;left: 20%;right: 20%;"><button type="button" class="close" data-dismiss="alert" aria-label="Close" style="position:relative;z-index:2"><span aria-hidden="true">&times;</span></button>There was an error while submitting the form. Please try again later</div>';
$submission = false;
...
<html lang="en">
  ...
  <?php if ( $submission = true ) { echo $responseArray['message']; }?>
       <nav id="header-bar" class="navbar navbar-fixed-top">
         <div class="container">
           <div class="navbar-header">
             ...
             <a class="navbar-brand page-scroll" href="#jumbotron"><span class="logo-1">T&amp;C</span><span class="logo-2">Entertainment</span></a>
           </div>
           <div id="navbar" class="navbar-collapse collapse">
             <a class="btn btn-default btn-user btn-info text-btn pull-right" href="#" role="button" type="button" data-toggle="modal" data-target="#myModal">Contact Us</a>
             <ul class="nav navbar-nav navbar-right text-nav">
               <li role="presentation"><a class="page-scroll" href="#services">Services</a></li>
               <li role="presentation"><a class="page-scroll" href="#people">People</a></li>
               <li role="presentation"><a class="page-scroll" href="#work">Work</a></li>
   <!--             <li role="presentation"><a class="page-scroll" href="#press">Press</a></li> -->
             </ul>
       ...
       <div id="jumbotron" class="jumbotron">
           <div class="jumbotron-background">
               <img src="img/image3.jpg" alt="lighthouse image">
               <!-- <video width="auto" height="auto" autoplay loop muted poster="img/lighthouse-sample-1.jpg">
       ...
       <div id="work" class="section-heading work">
         ...
         <!-- <p class="text-center divider lead">Films</p> -->
       </div>
       <div class="container work-content">
           ...
           <div class="col-xs-10 col-xs-offset-1">
             <div class="row">
               <div class="col-xs-6 col-sm-3 work-card-film">
                 <a href="https://www.youtube.com/watch?v=i-JxwEIP_u8">
               ...
               <div class="col-xs-6 col-sm-3 work-card-film">
                 <a href="https://www.youtube.com/watch?v=ZEEd6rnU1u0">
               ...
               <div class="col-xs-6 col-sm-3 work-card-film">
                 <a href="https://vimeo.com/88496894">
               ...
               <div class="col-xs-6 col-sm-3 visible-md-down work-card-film">
                 <a href="https://vimeo.com/78491251">
           ...
           <div class="col-xs-10 col-xs-offset-1">
             <div class="row">
               <div class="col-sm-4 work-card-short">
                 <a href="https://www.youtube.com/embed/2yhpN8qFBqE">
               ...
               <div class="col-sm-4 work-card-short">
                 <a href="https://www.youtube.com/embed/TO8gAvl59Kw">
               ...
               <div class="col-sm-4 work-card-short">
                 <a href='https://www.youtube.com/embed/OOhH_F9omtQ'>
               ...
               <div class="col-sm-4 work-card-short">
                 <a href='https://www.youtube.com/embed/U_cbCH1k3Kc'>
               ...
               <div class="col-sm-4 work-card-short">
                 <a href='https://www.youtube.com/embed/Ut3GXG1lFfk'>
               ...
               <div class="col-sm-4 work-card-short">
                 <a href='https://www.youtube.com/embed/4A1kH45TJG4'>
         ...
         <div class="row">
           ...
           <div class="col-xs-6 col-sm-2 work-card-comm">
             <a href="http://lrn.com/news-archive/lrn-wins-highest-honor-at-37th-annual-telly-awards/">
   ...
   <!--     <div id="press" class="section-heading press">
         <h2 class="text-center text-nav">Press</h2>
         <p class="text-center divider lead">Look at all of our successes. Marvel at them.</p>
       </div> -->
       ...
       <div class="bottom-signup">
         <div class="container">
           <div class="col-xs-8 col-xs-offset-2 col-md-5 col-md-offset-2">
             <p class="lead">You are one click away from calling action.</p>
             <p>Your consultation is free. We want to be on your team.</p>
           </div>
           <div class="col-xs-12 col-md-2 col-md-offset-1 signup-wrapper">
             <a class="btn btn-default btn-user btn-cta text-btn" href="#" role="button" type="button" data-toggle="modal" data-target="#myModal">Contact Us</a>
           </div>
         </div>
       </div>
       <div class="container">
         <footer>
           <div class="col-sm-3 footer-brand-wrapper">
             <p><a class="footer-brand" href="#"><span class="logo-1">T&amp;C</span><span class="logo-2">Entertainment</span></a></p>
             <span>&copy; 2016 T&amp;C Entertainment</span>
           </div>
           <div class="col-sm-9 footer-navigation-wrapper">
             <ul class="nav navbar-nav navbar-right text-nav">
               <li role="presentation"><a class="page-scroll" href="#services">Services</a></li>
               <li role="presentation"><a class="page-scroll" href="#people">People</a></li>
               <li role="presentation"><a class="page-scroll" href="#work">Work</a></li>
       ...
       <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         <div class="modal-dialog" role="document">
           <div class="modal-content">
             ...
             <?php include 'includes/newform.php'; ?>
