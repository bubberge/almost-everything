...
2. Upload all the files to the /wp-content/plugins/accesspress-pinterest
3. Activate the plugin through the 'Plugins' menu in WordPress.
4. For customizing the plugin's settings, click on AccessPress Pinterest menu in Wordpress left admin menu.
5. To display various pinterest widgets in sidebar please add the accesspress pinterest in widgets from widgets section.
...
3. Backend Display of Shortcodes.
4. Frontend Display of Shortcodes.
5. Backend display of Widgets.
6. Frontend display of Widgets.

== Changelog ==
= 3.0.4 =
* Compactibility check for wordpress veresion 4.4.
* Added pinterest share button using shortcode.

= 3.0.3 =
* Regeneration of pot file for language translation of a plugin.
* Done small bug fixings for the frontend and backend settings.

= 3.0.2 =
* Done the small bug fixing for the view on pinterest button.

= 3.0.1 =
* Removal of unnecessary php tags from the plugin files.

= 3.0.0 =
* Done the code formatting and removal of unncessary spacing in plugin files.

= 2.0.9 =
* Done the code formatting and removal of unnecessary php syntax.

= 2.0.8 =
* Removed unnecessary css from the plugins frontend css.
...
= 2.0.3 =
* Done the demo link url modification for the plugin.
* Code formatting to optimize the plugin.
...
* Code fixing for the follow and board widget links.

= 2.0.0 =
* Text corrections in the how to use section.
* Code formatting for the methods used in the pinterest class.
...
= 1.1.7 =
* Done the code fixing for the fetching of the latest pins for board widgets.

= 1.1.6 =
* Done the fixes for the plugin translation.
* Code optimization for the translation of a plugin.

= 1.1.5 =
* Pinterest pin it settings tab css fix.
* Removal of the unnecessary css codes for the backend.
* Latest pins widget and shortcode code modification for the display of the no feeds notification.

= 1.1.4 =
* Addition of the table border for how to use section.
...
= 1.0.7 =
* Fixed the div structure issue for the widgets area.
* Added the alt tag for the latest pins images.
* Fixed the latest pins fetch issue.

= 1.0.6 =
* Latest pins display bug fixing.

= 1.0.5 =
* Backend's about section css correction.
* Link addition to banner images.
* Code optimization of the plugin.
